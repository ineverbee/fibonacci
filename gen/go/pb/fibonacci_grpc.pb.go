...
type FibonacciClient interface {
	Fibo(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntSliceResponse, error)
}
...
func (c *fibonacciClient) Fibo(ctx context.Context, in *IntRequest, opts ...grpc.CallOption) (*IntSliceResponse, error) {
	out := new(IntSliceResponse)
	err := c.cc.Invoke(ctx, "/fibonacci.v1.Fibonacci/Fibo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	Fibo(context.Context, *IntRequest) (*IntSliceResponse, error)
...
func (UnimplementedFibonacciServer) Fibo(context.Context, *IntRequest) (*IntSliceResponse, error) {
...
func _Fibonacci_Fibo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibonacci.v1.Fibonacci/Fibo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).Fibo(ctx, req.(*IntRequest))
	}
...
var Fibonacci_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fibonacci.v1.Fibonacci",
